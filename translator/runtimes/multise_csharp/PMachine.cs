        ...
        for (ValueSummary<int> i = 0; vs_cond_20.Loop(i.InvokeBinary<int, bool>((l, r) => l < r, this.states.GetField<int>(_ => _.Count))); i.Increment())
        {
            ...
            var vs_cond_19 = ((new Func<ValueSummary<bool>>(() =>
            {
                ...
                if (vs_cond_39.CondTrue())
                    vs_cond_ret_39.Merge(vs_lgc_tmp_0.InvokeBinary<bool, bool>((l, r) => l & r, this.Transitions.GetIndex(state, e).InvokeBinary<PMachine.TransitionFunction, bool>((l, r) => l != r, new ValueSummary<PMachine.TransitionFunction>(null))));
