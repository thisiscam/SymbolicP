...
public class PMap<K, V> : IPType<PMap<K, V>> where K : IPType<K> where V : IPType<V>
{
    ...
    private void Insert(ValueSummary<K> k, ValueSummary<V> v)
    {
        ...
        for (ValueSummary<MapEntry> iter = ValueSummary<MapEntry>.InitializeFrom(firstEntry); vs_cond_28.Loop(iter.InvokeBinary<object, bool>((l, r) => l != r, new ValueSummary<object>(null))); firstEntry.Assign<PMap<K, V>.MapEntry>(firstEntry.GetField<PMap<K, V>.MapEntry>(_ => _.Next)))
        {
            ValueSummary<SymbolicBool> vs_lgc_tmp_0;
            var vs_cond_27 = ((new Func<ValueSummary<SymbolicBool>>(() =>
            {
                var vs_cond_51 = ((vs_lgc_tmp_0 = ValueSummary<SymbolicBool>.InitializeFrom(iter.GetField<SymbolicInteger>(_ => _.Hash).InvokeBinary<SymbolicInteger, SymbolicBool>((l, r) => l == r, hash)))).Cond();
                var vs_cond_ret_51 = new ValueSummary<SymbolicBool>();
                if (vs_cond_51.CondTrue())
                    vs_cond_ret_51.Merge(vs_lgc_tmp_0.InvokeBinary<SymbolicBool, SymbolicBool>((l, r) => l & r, iter.GetField<K>(_ => _.Key).InvokeMethod<K, SymbolicBool>((_, a0) => _.PTypeEquals(a0), k)));
                if (vs_cond_51.CondFalse())
                    vs_cond_ret_51.Merge(vs_lgc_tmp_0);
    ...
    private ValueSummary<V> Get(ValueSummary<K> k)
    {
        ...
        for (ValueSummary<MapEntry> iter = ValueSummary<MapEntry>.InitializeFrom(firstEntry); vs_cond_30.Loop(iter.InvokeBinary<object, bool>((l, r) => l != r, new ValueSummary<object>(null))); firstEntry.Assign<PMap<K, V>.MapEntry>(firstEntry.GetField<PMap<K, V>.MapEntry>(_ => _.Next)))
        {
            ValueSummary<SymbolicBool> vs_lgc_tmp_1;
            var vs_cond_29 = ((new Func<ValueSummary<SymbolicBool>>(() =>
            {
                var vs_cond_52 = ((vs_lgc_tmp_1 = ValueSummary<SymbolicBool>.InitializeFrom(iter.GetField<SymbolicInteger>(_ => _.Hash).InvokeBinary<SymbolicInteger, SymbolicBool>((l, r) => l == r, hash)))).Cond();
                var vs_cond_ret_52 = new ValueSummary<SymbolicBool>();
                if (vs_cond_52.CondTrue())
                    vs_cond_ret_52.Merge(vs_lgc_tmp_1.InvokeBinary<SymbolicBool, SymbolicBool>((l, r) => l & r, iter.GetField<K>(_ => _.Key).InvokeMethod<K, SymbolicBool>((_, a0) => _.PTypeEquals(a0), k)));
                if (vs_cond_52.CondFalse())
                    vs_cond_ret_52.Merge(vs_lgc_tmp_1);
            ...
            )())).Cond();
            {
                ...
                {
                    PathConstraint.RecordReturnPath(vs_ret_1, iter.GetField<V>(_ => _.Value), vs_cond_29);
                }
            }
    ...
    private void Set(ValueSummary<K> k, ValueSummary<V> v)
    {
        ...
        for (ValueSummary<MapEntry> iter = ValueSummary<MapEntry>.InitializeFrom(firstEntry); vs_cond_32.Loop(iter.InvokeBinary<object, bool>((l, r) => l != r, new ValueSummary<object>(null))); firstEntry.Assign<PMap<K, V>.MapEntry>(firstEntry.GetField<PMap<K, V>.MapEntry>(_ => _.Next)))
        {
            ValueSummary<SymbolicBool> vs_lgc_tmp_2;
            var vs_cond_31 = ((new Func<ValueSummary<SymbolicBool>>(() =>
            {
                var vs_cond_53 = ((vs_lgc_tmp_2 = ValueSummary<SymbolicBool>.InitializeFrom(iter.GetField<SymbolicInteger>(_ => _.Hash).InvokeBinary<SymbolicInteger, SymbolicBool>((l, r) => l == r, hash)))).Cond();
                var vs_cond_ret_53 = new ValueSummary<SymbolicBool>();
                if (vs_cond_53.CondTrue())
                    vs_cond_ret_53.Merge(vs_lgc_tmp_2.InvokeBinary<SymbolicBool, SymbolicBool>((l, r) => l & r, iter.GetField<K>(_ => _.Key).InvokeMethod<K, SymbolicBool>((_, a0) => _.PTypeEquals(a0), k)));
                if (vs_cond_53.CondFalse())
                    vs_cond_ret_53.Merge(vs_lgc_tmp_2);
    ...
    private void ResizeIfNecessary()
    {
        var vs_cond_35 = (this._count.InvokeBinary<int, int>((l, r) => l / r, this._capacity).InvokeBinary<double, bool>((l, r) => l > r, PMap<K, V>.LOAD_FACTOR)).Cond();
        {
            if (vs_cond_35.CondTrue())
            {
                ...
                for (ValueSummary<int> i = 0; vs_cond_34.Loop(i.InvokeBinary<int, bool>((l, r) => l < r, this._capacity)); i.Increment())
                {
                    var vs_cond_33 = PathConstraint.BeginLoop();
                    for (ValueSummary<MapEntry> iter = this.data.GetIndex<PMap<K, V>.MapEntry>(i); vs_cond_33.Loop(iter.InvokeBinary<object, bool>((l, r) => l != r, new ValueSummary<object>(null))); iter.Assign<PMap<K, V>.MapEntry>(iter.GetField<PMap<K, V>.MapEntry>(_ => _.Next)))
                    {
    ...
    public void Remove(ValueSummary<K> k)
    {
        ...
        {
            var vs_cond_54 = ((vs_lgc_tmp_3 = ValueSummary<SymbolicBool>.InitializeFrom(firstEntry.GetField<SymbolicInteger>(_ => _.Hash).InvokeBinary<SymbolicInteger, SymbolicBool>((l, r) => l == r, hash)))).Cond();
            var vs_cond_ret_54 = new ValueSummary<SymbolicBool>();
            if (vs_cond_54.CondTrue())
                vs_cond_ret_54.Merge(vs_lgc_tmp_3.InvokeBinary<SymbolicBool, SymbolicBool>((l, r) => l & r, firstEntry.GetField<K>(_ => _.Key).InvokeMethod<K, SymbolicBool>((_, a0) => _.PTypeEquals(a0), k)));
            if (vs_cond_54.CondFalse())
                vs_cond_ret_54.Merge(vs_lgc_tmp_3);
        ...
        )())).Cond();
        {
            if (vs_cond_38.CondTrue())
            {
                ...
                PathConstraint.RecordReturnPath(vs_cond_38);
            }

            if (vs_cond_38.CondFalse())
            {
                var vs_cond_37 = PathConstraint.BeginLoop();
                for (ValueSummary<MapEntry> iter = ValueSummary<MapEntry>.InitializeFrom(firstEntry); vs_cond_37.Loop(iter.InvokeBinary<object, bool>((l, r) => l != r, new ValueSummary<object>(null))); firstEntry.Assign<PMap<K, V>.MapEntry>(firstEntry.GetField<PMap<K, V>.MapEntry>(_ => _.Next)))
                {
                    ValueSummary<SymbolicBool> vs_lgc_tmp_4;
                    var vs_cond_36 = ((new Func<ValueSummary<SymbolicBool>>(() =>
                    {
                        var vs_cond_55 = ((vs_lgc_tmp_4 = ValueSummary<SymbolicBool>.InitializeFrom(iter.GetField<PMap<K, V>.MapEntry>(_ => _.Next).GetField<SymbolicInteger>(_ => _.Hash).InvokeBinary<SymbolicInteger, SymbolicBool>((l, r) => l == r, hash)))).Cond();
                        var vs_cond_ret_55 = new ValueSummary<SymbolicBool>();
                        if (vs_cond_55.CondTrue())
                            vs_cond_ret_55.Merge(vs_lgc_tmp_4.InvokeBinary<SymbolicBool, SymbolicBool>((l, r) => l & r, iter.GetField<PMap<K, V>.MapEntry>(_ => _.Next).GetField<K>(_ => _.Key).InvokeMethod<K, SymbolicBool>((_, a0) => _.PTypeEquals(a0), k)));
                        if (vs_cond_55.CondFalse())
                            vs_cond_ret_55.Merge(vs_lgc_tmp_4);
                ...
                vs_cond_37.MergeBranch(vs_cond_38);
            }
        }
    ...
    public ValueSummary<PBool> ContainsKey(ValueSummary<K> k)
    {
        ...
        for (ValueSummary<MapEntry> iter = ValueSummary<MapEntry>.InitializeFrom(firstEntry); vs_cond_40.Loop(iter.InvokeBinary<object, bool>((l, r) => l != r, new ValueSummary<object>(null))); firstEntry.Assign<PMap<K, V>.MapEntry>(firstEntry.GetField<PMap<K, V>.MapEntry>(_ => _.Next)))
        {
            ValueSummary<SymbolicBool> vs_lgc_tmp_5;
            var vs_cond_39 = ((new Func<ValueSummary<SymbolicBool>>(() =>
            {
                var vs_cond_56 = ((vs_lgc_tmp_5 = ValueSummary<SymbolicBool>.InitializeFrom(iter.GetField<SymbolicInteger>(_ => _.Hash).InvokeBinary<SymbolicInteger, SymbolicBool>((l, r) => l == r, hash)))).Cond();
                var vs_cond_ret_56 = new ValueSummary<SymbolicBool>();
                if (vs_cond_56.CondTrue())
                    vs_cond_ret_56.Merge(vs_lgc_tmp_5.InvokeBinary<SymbolicBool, SymbolicBool>((l, r) => l & r, iter.GetField<K>(_ => _.Key).InvokeMethod<K, SymbolicBool>((_, a0) => _.PTypeEquals(a0), k)));
                if (vs_cond_56.CondFalse())
                    vs_cond_ret_56.Merge(vs_lgc_tmp_5);
            ...
            )())).Cond();
            {
                ...
                {
                    PathConstraint.RecordReturnPath(vs_ret_6, (PBool)true, vs_cond_39);
                }
            }

            vs_cond_39.MergeBranch(vs_cond_40);
        }

        if (vs_cond_40.MergeBranch())
        {
    ...
    public ValueSummary<PMap<K, V>> DeepCopy()
    {
        ...
        for (ValueSummary<int> i = 0; vs_cond_41.Loop(i.InvokeBinary<int, bool>((l, r) => l < r, this._capacity)); i.Increment())
        {
    ...
    private ValueSummary<MapEntry> CopyEntryChain(ValueSummary<MapEntry> entry)
    {
        ...
        var vs_cond_42 = (entry.InvokeBinary<object, bool>((l, r) => l == r, new ValueSummary<object>(null))).Cond();
        {
            if (vs_cond_42.CondTrue())
            {
                PathConstraint.RecordReturnPath(vs_ret_8, new ValueSummary<PMap<K, V>.MapEntry>(null), vs_cond_42);
            }

            if (vs_cond_42.CondFalse())
            {
                PathConstraint.RecordReturnPath(vs_ret_8, new ValueSummary<PMap<K, V>.MapEntry>(new MapEntry(entry.GetField<K>(_ => _.Key), entry.GetField<SymbolicInteger>(_ => _.Hash), entry.GetField<V>(_ => _.Value).InvokeMethod((_) => _.DeepCopy()), this.CopyEntryChain(entry.GetField<PMap<K, V>.MapEntry>(_ => _.Next)))), vs_cond_42);
            }
        }
    ...
    public ValueSummary<SymbolicInteger> PTypeGetHashCode()
    {
        ...
        var vs_cond_44 = PathConstraint.BeginLoop();
        for (ValueSummary<int> i = 0; vs_cond_44.Loop(i.InvokeBinary<int, bool>((l, r) => l < r, this._capacity)); i.Increment())
        {
            ValueSummary<MapEntry> entry = this.data.GetIndex<PMap<K, V>.MapEntry>(i);
            var vs_cond_43 = PathConstraint.BeginLoop();
            while (vs_cond_43.Loop(entry.InvokeBinary<object, bool>((l, r) => l != r, new ValueSummary<object>(null))))
            {
    ...
    public ValueSummary<SymbolicBool> PTypeEquals(ValueSummary<PMap<K, V>> other)
    {
        ...
        var vs_cond_47 = (this.Count.InvokeBinary<int, bool>((l, r) => l != r, other.GetField<int>(_ => _.Count))).Cond();
        {
            if (vs_cond_47.CondTrue())
            {
                PathConstraint.RecordReturnPath(vs_ret_10, (SymbolicBool)false, vs_cond_47);
            }
        }

        if (vs_cond_47.MergeBranch())
        {
            var vs_cond_48 = PathConstraint.BeginLoop();
            for (ValueSummary<int> i = 0; vs_cond_48.Loop(i.InvokeBinary<int, bool>((l, r) => l < r, this._capacity)); i.Increment())
            {
                ValueSummary<MapEntry> entry = this.data.GetIndex<PMap<K, V>.MapEntry>(i);
                var vs_cond_46 = PathConstraint.BeginLoop();
                while (vs_cond_46.Loop(entry.InvokeBinary<object, bool>((l, r) => l != r, new ValueSummary<object>(null))))
                {
                    ValueSummary<SymbolicBool> vs_lgc_tmp_6;
                    var vs_cond_45 = ((new Func<ValueSummary<SymbolicBool>>(() =>
                    {
                        var vs_cond_57 = ((vs_lgc_tmp_6 = ValueSummary<SymbolicBool>.InitializeFrom(other.InvokeMethod<K, V>((_, a0) => _.Get(a0), entry.GetField<K>(_ => _.Key)).Cast<object>(_ => (object)_).InvokeBinary<object, SymbolicBool>((l, r) => l != r, new ValueSummary<object>(null))))).Cond();
                        var vs_cond_ret_57 = new ValueSummary<SymbolicBool>();
                        if (vs_cond_57.CondTrue())
                            vs_cond_ret_57.Merge(vs_lgc_tmp_6);
                        if (vs_cond_57.CondFalse())
                            vs_cond_ret_57.Merge(vs_lgc_tmp_6.InvokeBinary<SymbolicBool, SymbolicBool>((l, r) => l | r, entry.GetField<V>(_ => _.Value).InvokeMethod<V, SymbolicBool>((_, a0) => _.PTypeEquals(a0), other.InvokeMethod<K, V>((_, a0) => _[a0], entry.GetField<K>(_ => _.Key))).InvokeUnary<SymbolicBool>(_ => !_)));
                    ...
                    )())).Cond();
                    {
                        ...
                        {
                            PathConstraint.RecordReturnPath(vs_ret_10, (SymbolicBool)false, vs_cond_45);
                        }
                    }

                    vs_cond_45.MergeBranch(vs_cond_46);
                }

                vs_cond_46.MergeBranch(vs_cond_48);
            }

            if (vs_cond_48.MergeBranch())
            {
